...
Generate content for section `section-06-resource-components` (filename: `section-06-resource-components.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/neil/code/custom-apps/custom-app-base/claude-plan.md` - Full implementation plan
2. `/Users/neil/code/custom-apps/custom-app-base/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/neil/code/custom-apps/custom-app-base/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-06-resource-components` to understand what this section should contain.
...
`/Users/neil/code/custom-apps/custom-app-base/sections/section-06-resource-components.md`
