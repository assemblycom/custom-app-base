...
Generate content for section `section-10-agents-rewrite` (filename: `section-10-agents-rewrite.md`).
...
for `section-10-agents-rewrite` to understand what this section should contain.
...
`/Users/neil/code/custom-apps/custom-app-base/sections/section-10-agents-rewrite.md`
