...
Generate content for section `section-02-api-routes` (filename: `section-02-api-routes.md`).
...
for `section-02-api-routes` to understand what this section should contain.
...
`/Users/neil/code/custom-apps/custom-app-base/sections/section-02-api-routes.md`
