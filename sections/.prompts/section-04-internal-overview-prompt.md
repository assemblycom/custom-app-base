...
Generate content for section `section-04-internal-overview` (filename: `section-04-internal-overview.md`).
...
for `section-04-internal-overview` to understand what this section should contain.
...
`/Users/neil/code/custom-apps/custom-app-base/sections/section-04-internal-overview.md`
