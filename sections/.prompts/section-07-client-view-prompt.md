...
Generate content for section `section-07-client-view` (filename: `section-07-client-view.md`).
...
for `section-07-client-view` to understand what this section should contain.
...
`/Users/neil/code/custom-apps/custom-app-base/sections/section-07-client-view.md`
