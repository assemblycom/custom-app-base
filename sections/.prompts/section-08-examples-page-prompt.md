...
Generate content for section `section-08-examples-page` (filename: `section-08-examples-page.md`).
...
for `section-08-examples-page` to understand what this section should contain.
...
`/Users/neil/code/custom-apps/custom-app-base/sections/section-08-examples-page.md`
