...
Generate content for section `section-03-swr-hooks` (filename: `section-03-swr-hooks.md`).
...
for `section-03-swr-hooks` to understand what this section should contain.
...
`/Users/neil/code/custom-apps/custom-app-base/sections/section-03-swr-hooks.md`
