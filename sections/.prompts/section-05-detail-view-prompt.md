...
Generate content for section `section-05-detail-view` (filename: `section-05-detail-view.md`).
...
for `section-05-detail-view` to understand what this section should contain.
...
`/Users/neil/code/custom-apps/custom-app-base/sections/section-05-detail-view.md`
