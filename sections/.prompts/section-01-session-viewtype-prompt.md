...
Generate content for section `section-01-session-viewtype` (filename: `section-01-session-viewtype.md`).
...
for `section-01-session-viewtype` to understand what this section should contain.
...
`/Users/neil/code/custom-apps/custom-app-base/sections/section-01-session-viewtype.md`
